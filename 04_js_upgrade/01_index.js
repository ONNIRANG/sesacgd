...
// 전체 요소에 접근하고 싶은 경우
// 연산(계싼)등이 필요한 작업이 아닌 경우
// 전개 연산자 사용 -> 일일이 요소에 접근하지 않고 사용하도록 함
console.log(...lunchMenu);
...
function addNumber(...num) {
  console.log(num); // 전달받은 모든 인자는 num이라는 배열에 저장되어있음
